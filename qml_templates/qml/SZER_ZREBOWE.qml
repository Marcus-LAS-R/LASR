...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyLocal="1" maxScale="0" minScale="10050" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="1" version="3.14.1-Pi" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" type="singleSymbol" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol type="line" name="0" force_rhr="0" clip_to_extent="1" alpha="0.8">
        <layer enabled="1" class="ArrowLine" pass="0" locked="0">
          ...
          <symbol type="fill" name="@0@0" force_rhr="0" clip_to_extent="1" alpha="0.9">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOrientation="horizontal" fontKerning="1" textColor="245,0,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontLetterSpacing="0" fieldName="tostring(round($length,0)) + ' m'" fontUnderline="0" blendMode="0" multilineHeight="1" previewBkgrdColor="0,0,0,255" fontSizeUnit="Point" isExpression="1" fontWeight="50" fontStrikeout="0" fontWordSpacing="0" fontFamily="Noto Sans" useSubstitutions="0" allowHtml="0" textOpacity="1" fontCapitals="0" fontSize="6" namedStyle="Regular">
        <text-buffer bufferSizeUnits="MM" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferSize="1"/>
      ...
      <text-format autoWrapLength="0" rightDirectionSymbol=">" formatNumbers="0" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" plussign="0" addDirectionSymbol="0" wrapChar="" multilineAlign="0" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" decimals="3"/>
      <placement labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" fitInPolygonOnly="0" overrunDistanceUnit="MM" geometryGeneratorEnabled="0" offsetType="0" geometryGenerator="" polygonPlacementFlags="2" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" centroidInside="0" xOffset="0" priority="5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" rotationAngle="0" preserveRotation="1" overrunDistance="0" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" placement="2" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" placementFlags="10" distUnits="MM" offsetUnits="MM" yOffset="0"/>
      <rendering limitNumLabels="0" maxNumLabels="2000" obstacle="1" scaleMin="0" fontLimitPixelSize="0" upsidedownLabels="0" minFeatureSize="0" displayAll="1" scaleVisibility="1" mergeLines="0" scaleMax="10050" drawLabels="1" zIndex="0" fontMaxPixelSize="10000" fontMinPixelSize="3" obstacleType="1" obstacleFactor="1" labelPerPart="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <DiagramLayerSettings showAll="1" obstacle="0" priority="0" zIndex="0" linePlacementFlags="18" dist="0" placement="2">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0" field="typ"/>
  </constraints>
