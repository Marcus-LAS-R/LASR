...
<qgis readOnly="0" styleCategories="AllStyleCategories" minScale="100000000" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" version="3.14.1-Pi" labelsEnabled="0" simplifyLocal="1" simplifyDrawingTol="1" simplifyMaxScale="1">
  ...
  <renderer-v2 attr="x_kod" type="categorizedSymbol" symbollevels="0" enableorderby="0" forceraster="0">
    <categories>
      <category symbol="0" render="true" value="SKRP01" label="ALEJKA"/>
      <category symbol="1" render="true" value="SKRP02" label="ŚCIEŻKA"/>
      <category symbol="2" render="true" value="SKRP03" label="PASAŻ"/>
      <category symbol="3" render="true" value="" label=""/>
    </categories>
    <symbols>
      <symbol force_rhr="0" type="line" clip_to_extent="1" name="0" alpha="1">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="216,49,158,255"/>
      ...
      <symbol force_rhr="0" type="line" clip_to_extent="1" name="1" alpha="1">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="38,178,151,255"/>
          <prop k="line_style" v="dot"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <fieldConfiguration>
    ...
    <field name="klasaCiaguRuchuPieszego">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="x_doklGeom" index="8"/>
    <alias name="" field="x_doklGeom_uom" index="9"/>
    <alias name="" field="x_zrodloDanychG" index="10"/>
    <alias name="" field="x_zrodloDanychA" index="11"/>
    <alias name="" field="x_katIstnienia" index="12"/>
    <alias name="" field="x_rodzajReprGeom" index="13"/>
    <alias name="" field="x_aktualnoscG" index="14"/>
    <alias name="" field="x_aktualnoscA" index="15"/>
    <alias name="" field="poczatekWersjiObiektu" index="16"/>
    <alias name="" field="x_dataUtworzenia" index="17"/>
    <alias name="" field="x_kodKarto10k" index="18"/>
    <alias name="" field="x_kodKarto25k" index="19"/>
    <alias name="" field="x_kodKarto50k" index="20"/>
    <alias name="" field="x_kodKarto100k" index="21"/>
    <alias name="" field="x_kodKarto250k" index="22"/>
    <alias name="" field="x_kodKarto500k" index="23"/>
    <alias name="" field="x_kodKarto1000k" index="24"/>
    <alias name="" field="klasaCiaguRuchuPieszego" index="25"/>
    <alias name="" field="materialNawierzchni" index="26"/>
    <alias name="" field="polozenie" index="27"/>
    <alias name="" field="ruchRowerowy" index="28"/>
    <alias name="" field="schody" index="29"/>
    <alias name="" field="szerokosc" index="30"/>
    <alias name="" field="szerokosc_uom" index="31"/>
    <alias name="" field="x_informDodatkowa" index="32"/>
    <alias name="" field="nazwa" index="33"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="x_doklGeom"/>
    <default applyOnUpdate="0" expression="" field="x_doklGeom_uom"/>
    ...
    <default applyOnUpdate="0" expression="" field="klasaCiaguRuchuPieszego"/>
    <default applyOnUpdate="0" expression="" field="materialNawierzchni"/>
    <default applyOnUpdate="0" expression="" field="polozenie"/>
    <default applyOnUpdate="0" expression="" field="ruchRowerowy"/>
    <default applyOnUpdate="0" expression="" field="schody"/>
    <default applyOnUpdate="0" expression="" field="szerokosc"/>
    <default applyOnUpdate="0" expression="" field="szerokosc_uom"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="0" field="x_doklGeom" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="x_doklGeom_uom" constraints="0" unique_strength="0"/>
    ...
    <constraint exp_strength="0" notnull_strength="0" field="klasaCiaguRuchuPieszego" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="materialNawierzchni" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="polozenie" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="ruchRowerowy" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="schody" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="szerokosc" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="szerokosc_uom" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="x_informDodatkowa" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="nazwa" constraints="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="klasaCiaguRuchuPieszego" desc=""/>
    <constraint exp="" field="materialNawierzchni" desc=""/>
    <constraint exp="" field="polozenie" desc=""/>
    <constraint exp="" field="ruchRowerowy" desc=""/>
    <constraint exp="" field="schody" desc=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" width="-1" name="klasaCiaguRuchuPieszego" hidden="0"/>
      <column type="field" width="-1" name="materialNawierzchni" hidden="0"/>
      <column type="field" width="-1" name="polozenie" hidden="0"/>
      <column type="field" width="-1" name="ruchRowerowy" hidden="0"/>
      <column type="field" width="-1" name="schody" hidden="0"/>
      <column type="field" width="-1" name="szerokosc" hidden="0"/>
      <column type="field" width="-1" name="szerokosc_uom" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="klasaCiaguRuchuPieszego"/>
    ...
    <field editable="1" name="ruchRowerowy"/>
    <field editable="1" name="schody"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="klasaCiaguRuchuPieszego"/>
    ...
    <field labelOnTop="0" name="ruchRowerowy"/>
    <field labelOnTop="0" name="schody"/>
