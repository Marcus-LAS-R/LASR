...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_czysc_cue = QtWidgets.QCheckBox(self.grupBox)
        self.checkBox_czysc_cue.setGeometry(QtCore.QRect(60, 180, 781, 22))
        self.checkBox_czysc_cue.setChecked(False)
        self.checkBox_czysc_cue.setEnabled(False)
        self.checkBox_czysc_cue.setObjectName("checkBox_czysc_cue")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_czysc_cue.setText(_translate("Dialog", "Wyczyść tabelę F_AROD_CUE przed dopisaniem (zabiegi zostaną wygenerowane od zera)"))
