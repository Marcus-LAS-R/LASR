...
# Form implementation generated from reading ui file 'ui_baza_dopiszFO.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Ui_Dialog):
        ...
        self.lineEdit_baza.setGeometry(QtCore.QRect(160, 60, 381, 32))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.lineEdit_baza.setFont(font)
        self.lineEdit_baza.setObjectName("lineEdit_baza")
        self.lineEdit_fochr = QtWidgets.QLineEdit(Ui_Dialog)
        self.lineEdit_fochr.setGeometry(QtCore.QRect(160, 110, 381, 32))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.lineEdit_fochr.setFont(font)
        self.lineEdit_fochr.setObjectName("lineEdit_fochr")
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 120, 141, 18))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.pushButton_fochr = QtWidgets.QPushButton(Ui_Dialog)
        self.pushButton_fochr.setGeometry(QtCore.QRect(550, 110, 88, 34))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.pushButton_fochr.setFont(font)
        self.pushButton_fochr.setObjectName("pushButton_fochr")
    ...
    def retranslateUi(self, Ui_Dialog):
        ...
        Ui_Dialog.setWindowTitle(_translate("Ui_Dialog", "Dopisz formy ochrony - podaj dane"))
        ...
        self.label_3.setText(_translate("Ui_Dialog", "Warstwa F_OCHRONY:"))
        self.pushButton_wydz.setText(_translate("Ui_Dialog", "Wybierz"))
        self.pushButton_baza.setText(_translate("Ui_Dialog", "Wybierz"))
        self.pushButton_fochr.setText(_translate("Ui_Dialog", "Wybierz"))
